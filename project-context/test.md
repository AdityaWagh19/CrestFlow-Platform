...
| ------------------------------------------- | ------ | ------- | ---------------------------------------------- |
| Project Setup (Plan 00)                     | 80%+   | —       | Env validation, decimal helpers, error mapping |
...
| ID    | Test                                                    | Status |
| ----- | ------------------------------------------------------- | ------ |
| P0-01 | `pnpm install` runs without errors                      | [P]    |
| P0-02 | `turbo run build` succeeds for all 3 packages           | [P]    |
| P0-03 | `turbo run type-check` passes with zero errors          | [P]    |
| P0-04 | Prisma client generates successfully                    | [P]    |
| P0-05 | Env validation (Zod) — crashes on missing required vars | [ ]    |
| P0-06 | Decimal.js precision set to 28 with ROUND_HALF_UP       | [ ]    |
| P0-07 | Logger creates child loggers with module field          | [ ]    |
| P0-08 | All error types map to correct HTTP status codes        | [ ]    |
| P0-09 | Health endpoint returns `{ status: 'ok' }`              | [ ]    |
| P0-10 | ESLint `parseFloat` ban fires on financial code         | [ ]    |
